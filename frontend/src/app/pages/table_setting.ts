export class TableSetting {
    ...
    constructor(columns: object) {
        this.settings = {
            ...
            edit: {
                confirmSave: true,
                editButtonContent: '<div class="btn btn-success btn-sm mx-1 px-2">Edit</div>',
                saveButtonContent: '<div class="btn btn-success btn-sm mx-1 px-2">Save</div>',
                cancelButtonContent: '<div class="btn btn-danger btn-sm mx-1 px-2">Cancel</div>',
            },
            delete: {
                confirmDelete: true,
                deleteButtonContent: '<div class="btn btn-danger btn-sm mx-1 px-2">Delete</div>',
            },
            attr: {
